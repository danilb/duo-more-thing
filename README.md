...
за датчиком, и через сколько секунд неподвижной крышки эффект отпускает экран
(страховка, чтобы полуприкрытой крышкой можно было пользоваться).
